...
-- ----------------------------
-- Table structure for data_control
-- ----------------------------
DROP TABLE IF EXISTS `data_control`;
CREATE TABLE `data_control` (
  `id` varchar(35) NOT NULL COMMENT '主键',
  `dataControlId` varchar(20) DEFAULT NULL COMMENT '数据控制id',
  `control` varchar(512) DEFAULT NULL COMMENT '控制逻辑',
...
CREATE TABLE `role_permission` (
  `id` varchar(35) NOT NULL,
  `rolePermissionId` varchar(20) DEFAULT NULL COMMENT '角色权限id',
...
-- ----------------------------
-- Table structure for role_permission_data_control
-- ----------------------------
DROP TABLE IF EXISTS `role_permission_data_control`;
CREATE TABLE `role_permission_data_control` (
  `id` varchar(35) NOT NULL COMMENT '主键',
  `dataControlId` varchar(20) DEFAULT NULL COMMENT '数据权限id',
  `rolePermissionId` varchar(20) DEFAULT NULL COMMENT '角色权限id',
  `describe` varchar(100) DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='权限数据控制表';
